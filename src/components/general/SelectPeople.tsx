  ...
  return (
    <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
      <div className="grid items-center gap-6 text-white">
        <li
          className={clsx(
            "half-day grid h-[300px] w-[270px] sm:w-[350px] cursor-pointer flex-col place-content-center items-center justify-center gap-3 rounded-lg border-2 border-[#1f788b] p-5 text-center text-lg text-[#1f788b] md:w-[400px] lg:text-2xl",
          )}
        >
