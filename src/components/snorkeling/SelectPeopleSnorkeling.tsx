        ...
        <>
          <div className="flex w-full flex-col gap-y-6">
            <div className="flex flex-col items-center gap-6 text-white">
              <li
                className={clsx(
                  "half-day grid h-[250px] w-full cursor-pointer flex-col place-content-center items-center justify-center gap-3 rounded-lg border-2 border-[#1f788b] p-5 text-center text-lg text-[#1f788b] lg:text-2xl",
                )}
              >
